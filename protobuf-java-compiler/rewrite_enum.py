...
file_path = r"c:\Users\Dave\git\protobuf-java\protobuf-java-compiler\src\main\java\com\rubberjam\protobuf\compiler\java\full\RepeatedEnumFieldGenerator.java"
with open(file_path, "r", encoding="utf-8") as f:
    orig_code = f.read()

# We can replace the methods entirely.
# Here is the target java code:
java_code = """
...
public class RepeatedEnumFieldGenerator extends ImmutableFieldGenerator {
    ...
    public void generateInterfaceMembers(Printer printer) {
        ...
        DocComment.writeFieldAccessorDocComment(printer, descriptor, DocComment.AccessorType.LIST_INDEXED_GETTER,
                context.getOptions());
        printer.emit(variables, "$type$ get$capitalized_name$(int index);\\n");

        if (InternalHelpers.supportUnknownEnumValue(descriptor)) {
            DocComment.writeFieldEnumValueAccessorDocComment(printer, descriptor, DocComment.AccessorType.LIST_GETTER,
                    context.getOptions());
    ...
    public void generateBuilderMembers(Printer printer) {
        ...
        if (InternalHelpers.supportUnknownEnumValue(descriptor)) {
            ...
            printer.emit(variables,
                    ...
                    "  return $name$_.getInt(index);\\n" +
                    "}\\n");
            DocComment.writeFieldEnumValueAccessorDocComment(printer, descriptor, DocComment.AccessorType.LIST_INDEXED_SETTER, context.getOptions(), true);
            printer.emit(variables,
                    ...
                    "  return this;\\n" +
                    "}\\n");
            DocComment.writeFieldEnumValueAccessorDocComment(printer, descriptor, DocComment.AccessorType.LIST_ADDER, context.getOptions(), true);
            printer.emit(variables,
                    ...
                    "  return this;\\n" +
                    "}\\n");
            DocComment.writeFieldEnumValueAccessorDocComment(printer, descriptor, DocComment.AccessorType.LIST_MULTI_ADDER, context.getOptions(), true);
            printer.emit(variables,
    ...
    @Override
    public void generateHashCode(Printer printer) {
        printer.emit(variables,
