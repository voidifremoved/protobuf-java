...
public final class Options {
  ...
  public static Options fromParameter(String parameter) {
    ...
    if (!options.generateImmutableCode && !options.generateMutableCode && !options.generateSharedCode) {
        ...
        // if (!options.generate_immutable_code && !options.generate_mutable_code && !options.generate_shared_code) {
        ...
        // if (!fileOptions.generateImmutableCode && !fileOptions.generateMutableCode && !fileOptions.generateSharedCode) {
        ...
        // The C++ struct constructor initializes them to false. The *Generator* class sets defaults if none are set.
