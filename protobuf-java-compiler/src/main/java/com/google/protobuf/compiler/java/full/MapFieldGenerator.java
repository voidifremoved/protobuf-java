...
public class MapFieldGenerator extends ImmutableFieldGenerator {
  ...
  private void setMessageVariables(
    ...
    variables.put("value_type", StringUtils.getPrimitiveTypeName(StringUtils.getJavaType(value))); // Need to handle Objects
  ...
  public void generateMembers(PrintWriter printer) {
    printer.println("  private com.google.protobuf.MapField<" + variables.get("type_parameters") + "> " + variables.get("name") + "_;");
    ...
    printer.println("  public java.util.Map<" + variables.get("type_parameters") + "> get" + variables.get("capitalized_name") + "Map() {");
  ...
  public void generateBuilderMembers(PrintWriter printer) {
    ...
    printer.println("  public java.util.Map<" + variables.get("type_parameters") + "> getMutable" + variables.get("capitalized_name") + "() {");
