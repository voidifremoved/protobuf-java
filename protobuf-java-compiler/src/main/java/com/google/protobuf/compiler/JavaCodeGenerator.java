...
public class JavaCodeGenerator extends CodeGenerator {
  ...
  public void generate(FileDescriptor file, String parameter, GeneratorContext generatorContext)
    ...
    if (fileOptions.generateImmutableCode) {
      fileGenerators.add(new FileGenerator(file, fileOptions, /* immutable= */ true));
    }
    ...
    try {
      for (FileGenerator fileGenerator : fileGenerators) {
        ...
        try (java.io.PrintWriter writer =
            new java.io.PrintWriter(generatorContext.open(javaFilename))) {
      ...
      if (fileOptions.outputListFile != null) {
        try (java.io.PrintWriter writer =
            new java.io.PrintWriter(generatorContext.open(fileOptions.outputListFile))) {
      ...
      if (fileOptions.annotationListFile != null) {
        try (java.io.PrintWriter writer =
            new java.io.PrintWriter(generatorContext.open(fileOptions.annotationListFile))) {
