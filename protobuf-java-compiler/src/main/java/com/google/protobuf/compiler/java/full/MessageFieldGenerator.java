...
public class MessageFieldGenerator extends ImmutableFieldGenerator {
  ...
  public static class RepeatedMessageFieldGenerator extends ImmutableFieldGenerator {
    ...
    @Override
    public void generateInterfaceMembers(PrintWriter printer) {
      printer.println("  java.util.List<" + variables.get("type") + "> get" + variables.get("capitalized_name") + "List();");
      ...
      printer.println("  java.util.List<? extends " + variables.get("type") + "OrBuilder> get" + variables.get("capitalized_name") + "OrBuilderList();");
      printer.println("  " + variables.get("type") + "OrBuilder get" + variables.get("capitalized_name") + "OrBuilder(int index);");
    }
    ...
    public void generateMembers(PrintWriter printer) {
      ...
      printer.println("  @java.lang.Override");
      printer.println("  public java.util.List<" + variables.get("type") + "> get" + variables.get("capitalized_name") + "List() {");
      printer.println("    return " + variables.get("name") + "_;");
      printer.println("  }");

      printer.println("  @java.lang.Override");
      printer.println("  public java.util.List<? extends " + variables.get("type") + "OrBuilder> get" + variables.get("capitalized_name") + "OrBuilderList() {");
      printer.println("    return " + variables.get("name") + "_;");
      printer.println("  }");
      ...
      printer.println("  @java.lang.Override");
      printer.println("  public " + variables.get("type") + "OrBuilder get" + variables.get("capitalized_name") + "OrBuilder(int index) {");
      printer.println("    return " + variables.get("name") + "_.get(index);");
      printer.println("  }");
    }
    ...
    @Override
    public void generateBuilderMembers(PrintWriter printer) {
      printer.println("  private java.util.List<" + variables.get("type") + "> " + variables.get("name") + "_ = java.util.Collections.emptyList();");
      printer.println("  private com.google.protobuf.RepeatedFieldBuilder<" + variables.get("type") + ", " + variables.get("type") + ".Builder, " + variables.get("type") + "OrBuilder> " + variables.get("name") + "Builder_;");

      printer.println("  private void ensure" + variables.get("capitalized_name") + "IsMutable() {");
      printer.println("    if (!(" + variables.get("name") + "_.getClass() == java.util.ArrayList.class)) {"); // Simplified check
      printer.println("      " + variables.get("name") + "_ = new java.util.ArrayList<" + variables.get("type") + ">(" + variables.get("name") + "_);");
      printer.println("    }");
      printer.println("  }");
      ...
      printer.println("  public Builder set" + variables.get("capitalized_name") + "(int index, " + variables.get("type") + " value) {");
      printer.println("    if (" + variables.get("name") + "Builder_ == null) {");
      printer.println("      if (value == null) { throw new NullPointerException(); }");
      ...
      printer.println("  public Builder addAll" + variables.get("capitalized_name") + "(java.lang.Iterable<? extends " + variables.get("type") + "> values) {");
      printer.println("    if (" + variables.get("name") + "Builder_ == null) {");
      printer.println("      ensure" + variables.get("capitalized_name") + "IsMutable();");
    ...
    public void generateBuildingCode(PrintWriter printer) {
        ...
        printer.println("          " + variables.get("name") + "_ = java.util.Collections.unmodifiableList(" + variables.get("name") + "_);");
        printer.println("        }");
        printer.println("        result." + variables.get("name") + "_ = " + variables.get("name") + "_;");
        printer.println("      } else {");
        printer.println("        result." + variables.get("name") + "_ = " + variables.get("name") + "Builder_.build();");
