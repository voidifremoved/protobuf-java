...
public class ImmutableMessageGenerator extends GeneratorFactory.MessageGenerator {
    ...
    public int generateStaticVariableInitializers(Printer printer) {
        ...
        for (Descriptor nested : descriptor.getNestedTypes()) {
            bytecodeEstimate += new ImmutableMessageGenerator(nested, context)
    ...
    private void generateFieldAccessorTable(Printer printer, int[] bytecodeEstimate) {
        ...
        printer.print(vars,
                "$private$static $final$\n" +
                        ...
                        "    internal_static_$identifier$_fieldAccessorTable;\n");
    ...
    private int generateFieldAccessorTableInitializer(Printer printer) {
        ...
        printer.print(
                "internal_static_" + Helpers.uniqueFileScopeIdentifier(descriptor) + "_fieldAccessorTable = new\n" +
    ...
    public void generateInterface(Printer printer) {
        if (Helpers.isOwnFile(descriptor, true)) {
        ...
        if (descriptor.toProto().getExtensionRangeCount() > 0) {
            printer.print(
                    deprecation + "public interface " + descriptor.getName() + "OrBuilder extends\n" +
                            ...
                            "    // @@protoc_insertion_point(interface_extends:" + descriptor.getFullName() + ")\n" +
                            "    com.google.protobuf.GeneratedMessage" + Helpers.getGeneratedCodeVersionSuffix() + ".\n"
                            +
        ...
        for (OneofDescriptor oneof : oneofs.values()) {
            if (com.google.protobuf.CompilerInternalHelpers.isSynthetic(oneof))
                continue;
    ...
    public void generate(Printer printer) {
        ...
        if (descriptor.toProto().getExtensionRangeCount() > 0) {
            printer.print(vars,
                    "$deprecation$public $static$final class $classname$ extends\n" +
                            ...
                            (Helpers.getExtraMessageInterfaces(descriptor).isEmpty() ? "" : "    $extra_interfaces$\n")
                            +
                            "    // @@protoc_insertion_point(message_implements:" + descriptor.getFullName() + ")\n" +
                            "    $classname$OrBuilder {\n");
            builderType = "com.google.protobuf.GeneratedMessage" + Helpers.getGeneratedCodeVersionSuffix()
                    + ".ExtendableBuilder<" +
        ...
        // Note: This duplicates what is in generateStaticVariables for Java 1.7
        ...
        printer.print(vars,
                "static {\n" +
                        ...
                        "    /* major= */ "
                        + com.rubberjam.protobuf.compiler.Versions.getProtobufJavaVersion(false).getMajor() + ",\n" +
                        "    /* minor= */ "
                        + com.rubberjam.protobuf.compiler.Versions.getProtobufJavaVersion(false).getMinor() + ",\n" +
                        "    /* patch= */ "
                        + com.rubberjam.protobuf.compiler.Versions.getProtobufJavaVersion(false).getPatch() + ",\n" +
                        "    /* suffix= */ \""
                        + com.rubberjam.protobuf.compiler.Versions.getProtobufJavaVersion(false).getSuffix() + "\",\n" +
                        "    \"$classname$\");\n" +
                        "}\n");
    ...
    private void generateDescriptorMethods(Printer printer) {
        ...
        printer.print(
                "@java.lang.Override\n" +
                        "protected com.google.protobuf.GeneratedMessage" + Helpers.getGeneratedCodeVersionSuffix()
                        + ".FieldAccessorTable\n" +
    ...
    private void generateAnyMethods(Printer printer) {
        ...
        // Based on the C++ code I fetched, it is quite long. I will implement a
        // placeholder or TODO,
            ...
            if (field.getJavaType() == FieldDescriptor.JavaType.MESSAGE &&
                ...
                if (field.isRequired()) {
                    ...
                    if (field.isMapField()) {
                        // ...
                        printer.print(
                                "for (" + mapValueImmutableClassdName(field.getMessageType(), nameResolver)
                                        + " item : get" + name + "Map().values()) {\n" +
    ...
    private void generateEqualsAndHashCode(Printer printer) {
        ...
        printer.print(
                "if (obj == this) {\n" +
                        ...
                        "}\n" +
                        nameResolver.getImmutableClassName(descriptor) + " other = ("
                        + nameResolver.getImmutableClassName(descriptor) + ") obj;\n" +
                        "\n");
