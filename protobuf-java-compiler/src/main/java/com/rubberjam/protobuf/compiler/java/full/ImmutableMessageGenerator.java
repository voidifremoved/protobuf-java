...
public class ImmutableMessageGenerator extends GeneratorFactory.MessageGenerator {
  ...
  public void generate(Printer printer) {
      ...
      printer.print(vars,
          ...
          "    /* major= */ " + com.rubberjam.protobuf.compiler.Versions.getProtobufJavaVersion(false).getMajor() + ",\n" +
          "    /* minor= */ " + com.rubberjam.protobuf.compiler.Versions.getProtobufJavaVersion(false).getMinor() + ",\n" +
          "    /* patch= */ " + com.rubberjam.protobuf.compiler.Versions.getProtobufJavaVersion(false).getPatch() + ",\n" +
          "    /* suffix= */ \"" + com.rubberjam.protobuf.compiler.Versions.getProtobufJavaVersion(false).getSuffix() + "\",\n" +
          "    \"$classname$\");\n" +
          "}\n");
