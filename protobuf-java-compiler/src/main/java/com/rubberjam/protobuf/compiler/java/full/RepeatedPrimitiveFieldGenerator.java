...
public class RepeatedPrimitiveFieldGenerator extends ImmutableFieldGenerator {
        public RepeatedPrimitiveFieldGenerator(
                ...
                String primitiveTypeName = (String) variables.get("type");
                String listType = primitiveTypeName.substring(0, 1).toUpperCase() + primitiveTypeName.substring(1);
        ...
        public void generateBuilderMembers(Printer printer) {
                printer.emit(variables,
                                "private com.google.protobuf.Internal.$list_type$List $name$_ = empty$list_type$List();\n"
                                                +
                ...
                DocComment.writeFieldAccessorDocComment(printer, descriptor,
                                DocComment.AccessorType.LIST_INDEXED_SETTER,
                                context.getOptions(), true);
                printer.emit(variables,
