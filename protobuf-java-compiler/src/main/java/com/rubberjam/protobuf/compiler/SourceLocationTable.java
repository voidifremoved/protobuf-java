...
public final class SourceLocationTable
{
	...
	// Since Java's DescriptorPool doesn't expose ErrorLocation directly in the
	// same way C++ does (it uses callbacks with string paths usually),
	// we might need to define our own or see if we can use something close.
	// C++ defines: NAME, NUMBER, TYPE, EXTENDEE, DEFAULT_VALUE, OPTION_NAME,
	// OPTION_VALUE, INPUT_TYPE, OUTPUT_TYPE, IMPORT, OTHER
