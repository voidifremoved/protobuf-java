...
public class CompilerDependencyTest
{
	...
	public void testCompileWithMissingDependencyProvidedByResolver() throws Exception
	{
		...
		// Should contain Person.java or PersonOuterClass.java or
		// PersonProto.java
		...
		// Should NOT contain Address.java because it was not in the initial
		// protoFileContents map
		// (It was loaded as a dependency)
		// Wait, my logic in Compiler says: "Only generate code for the
		// requested files"
		...
		{
			// This is acceptable behavior if we decide dependencies should be
			// generated too?
			// But typically we only generate for the input files.
			// Let's enforce that dependencies are NOT generated unless
			// requested.
